...
{
    protected $rule = [
        'timestamp|微信时间戳'=>'length:0,255',
        'nonce|微信随机数'=>'length:0,255',
        'encrypt_type|微信加密类型'=>'length:0,20',
        'msg_signature|微信消息签名体'=>'length:0,255',
        'signature|签名'=>'length:0,255',
        'token|开放平台设置的token'=>'length:0,255',
        'encoding_aes_key|加密aesKey'=>'length:0,255',
        'component_appid|开放平台appid'=>'length:0,20',
        'component_appsecret|第三方平台appsecret'=>'length:0,100',
        'component_verify_ticket|微信后台推送的ticket'=>'length:0,100',
        'component_access_token|第三方access_token'=>'length:0,255',
        'pre_auth_code|预授权code'=>'length:0,255',
        'redirect_uri|授权回调地址'=>'length:0,255',
        'auth_type|授权类型'=>'in:1,2,3',
        'authorization_code|授权码'=>'length:0,255',
        'authorizer_appid|授权公众号appid'=>'length:0,20',
        'authorizer_refresh_token|刷新access_token'=>'length:0,255',
        'option_name|选项名称'=>'length:0,50',
        'option_value|选项值'=>'length:0,50',
        'offset|起始位置'=>'number',
        'count|拉取数量'=>'number',
        'access_token|access_token' => 'length:0,255',
        'appid|公众号appid' => 'length:0,50',
        'scope|授权作用域' => 'in:snsapi_base,snsapi_userinfo',
        'state|state参数'=>'length:0,128',
        'code|参数'=>'length:0,128',
        'openid|openid'=>'length:0,50',
        'expire_seconds|过期时间'=>'number',
        'action_name|二维码类型'=>'in:QR_SCENE,QR_STR_SCENE,QR_LIMIT_SCENE,QR_LIMIT_STR_SCENE',
